...
\end{beispiel}
Die vorherigen Beispiele zeigen, dass die Standard-Ansätze modifiziert werden müssen. Für Randwertprobleme bedeutet dies, dass weitere 'Korrekturfunktionen' hinzugefügt werden müssen. Diese werden \markdef{Grenzschichtkorrekturen} genannt. 
